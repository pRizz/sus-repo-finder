...
This command **requires** the project directory as an argument via `/Users/peterryszkiewicz/Repos/sus-repo-finder`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/peterryszkiewicz/Repos/sus-repo-finder/prompts/app_spec.txt` and `/Users/peterryszkiewicz/Repos/sus-repo-finder/prompts/initializer_prompt.md`

If `/Users/peterryszkiewicz/Repos/sus-repo-finder` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/peterryszkiewicz/Repos/sus-repo-finder/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/peterryszkiewicz/Repos/sus-repo-finder/prompts/app_spec.txt`
...
**Output path:** `/Users/peterryszkiewicz/Repos/sus-repo-finder/prompts/initializer_prompt.md`
...
**Output path:** `/Users/peterryszkiewicz/Repos/sus-repo-finder/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/peterryszkiewicz/Repos/sus-repo-finder/prompts/`!
>
> **Files created:**
> - `/Users/peterryszkiewicz/Repos/sus-repo-finder/prompts/app_spec.txt`
> - `/Users/peterryszkiewicz/Repos/sus-repo-finder/prompts/initializer_prompt.md`
>
